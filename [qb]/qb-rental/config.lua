...
Config.vehicleList = {
    { name = "Scorcher", model = "scorcher", price = 10, needLicense = false},
    { name = "Zombie Chopper", model = "zombieb", price = 100, needLicense = true },
    { name = "Dilettante", model = "dilettante", price = 500 , needLicense = true},
    { name = "Novak", model = "novak", price = 500 , needLicense = true},
}
