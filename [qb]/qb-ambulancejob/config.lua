...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(-674.99, 326.52, 83.08),
	    -- [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
        [2] = vector3(-673.83, 325.35, 88.02)
    },
    ["duty"] = {
        -- [1] = vector3(311.18, -599.25, 43.29),
        [1] = vector3(-661.01, 310.21, 92.74), 
        -- [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        -- [1] = vector4(294.578, -574.761, 43.179, 35.79),
        -- [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
        [1] = vector4(-673.59, 367.92, 78.12, 352.3),
        [2] = vector4(-697.95, 370.62, 78.12, 171.83),
        [3] = vector4(-694.42, 370.29, 78.12, 206.68),
        [4] = vector4(-690.89, 370.27, 78.12, 156.11),
        [5] = vector4(-687.54, 370.06, 78.12, 179.05),
        [6] = vector4(-683.9, 369.92, 78.12, 168.36),
        [7] = vector4(-680.35, 369.42, 78.12, 189.84),
        [8] = vector4(-676.93, 369.32, 78.12, 193.5),
        [9] = vector4(-673.69, 368.96, 78.12, 173.74),
        [10] = vector4(-670.17, 368.56, 78.12, 202.25),
        [11] = vector4(-666.88, 368.3, 78.12, 177.89),
        [12] = vector4(-663.38, 368.17, 78.12, 182.76),
        [13] = vector4(-659.89, 367.73, 78.12, 169.26),
        [14] = vector4(-656.59, 367.45, 78.12, 204.73),
        [15] = vector4(-653.1, 367.0, 78.12, 251.11),
        [16] = vector4(-650.32, 366.74, 78.12, 229.41),
        [17] = vector4(-646.47, 365.61, 78.12, 230.54),
    },
    ["helicopter"] = {
        [1] = vector4(-644.59, 315.01, 140.15, 62.0),
    },
    ["armory"] = {
        [1] = vector3(-674.18, 338.19, 83.08)
    },
    ["roof"] = {
        [1] = vector4(-644.59, 315.01, 140.15, 62.0),
    },
    ["main"] = {
        [1] = vector3(-673.22, 317.99, 83.08),
    },
    ["stash"] = {
        [1] = vector3(-681.6, 329.14, 83.08),
    },
    ["beds"] = {
        [1] = {coords = vector4(-667.0571, 314.8237, 87.0081, 350.32), taken = false, model = 2179859320},
        [2] = {coords = vector4(-671.5956, 315.1574, 87.0081, 350.32), taken = false, model = 1864723433},
        [3] = {coords = vector4(-676.2513, 315.6695, 87.0081, 350.32), taken = false, model = 1864721858},
        [4] = {coords = vector4(-681.1139, 320.1721, 87.00807, 80.32), taken = false, model = 2179861005},
        [5] = {coords = vector4(-680.6978, 324.8093, 87.0081, 80.32), taken = false, model = 2179861014},
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(-681.04, 318.59, 83.08, 174.23) }
    }
}
